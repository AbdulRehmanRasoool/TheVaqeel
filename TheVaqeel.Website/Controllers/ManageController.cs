...
namespace TheVaqeel.Website.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangePassword()
        {
            ...
            var navbarElement = context.HomeNavbars.SingleOrDefault(n => n.Id == 1);
            homeViewModel.HomeNavbar = navbarElement;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangePassword(HomeViewModel model)
        {
            var navbarElement = context.HomeNavbars.SingleOrDefault(n => n.Id == 1);
            model.HomeNavbar = navbarElement;
            if (!ModelState.IsValid)
            {
                return View(model);
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeLawyerPassword(HomeViewModel model)
        {
            var navbarElement = context.HomeNavbars.SingleOrDefault(n => n.Id == 1);
            model.HomeNavbar = navbarElement;
            if (!ModelState.IsValid)
